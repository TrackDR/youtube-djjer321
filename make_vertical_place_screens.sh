...
# Placement (pixels from top of 1080x1920 canvas)
TOP_Y=75
BOT_Y=1022
...
END{
  for(i=0;i<n;i++){
    ...
    if(mode[i]==1){
      ...
      # Layout 2 → crop two screens, scale to 1080w, overlay at given Y on 1080x1920 canvas
      # Build a black background, then overlay TOP at y=topy, then BOTTOM at y=boty
